...
Matrix Matrix::scaleFigure(const double &scale){
    Matrix matrix;
    matrix( 1, 1) = scale;
    matrix( 2, 2) = scale;
    matrix( 3, 3) = scale;
...
Matrix Matrix::rotateX(const double &angle){
    Matrix matrix;
    matrix( 1, 1) = 1;
    matrix( 4, 4) = 1;
...
Matrix Matrix::rotateY(const double &angle){
    Matrix matrix;
...
Matrix Matrix::rotateZ(const double &angle){
    Matrix matrix;
    matrix( 1, 1) = cos((angle));
...
Matrix Matrix::translate(const Vector3D &vector){
    Matrix matrix;
    matrix( 1, 1) = 1;
    matrix( 2, 2) = 1;
    matrix( 3, 3) = 1;
...
void Matrix::toPolar(const Vector3D &point, double &r, double &theta, double &phi){
    double x = point.x;
    double y = point.y;
    double z = point.z;
...
Matrix Matrix::eyePointTrans(const Vector3D &eyepoint){
    double r;
    double theta;
    double phi;
