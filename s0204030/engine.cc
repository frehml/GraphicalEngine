...
img::EasyImage generate_image(const ini::Configuration &configuration)
{
    ...
    if (type == "2DLSystem")
        ...
        return Wireframe::generateImage(configuration, background_color, size, false);
    else if (type == "ZBufferedWireframe")
        return Wireframe::generateImage(configuration, background_color, size, true);
    else if (type == "ZBuffering")
        return ZBuffer::generateImage(configuration, background_color, size);
